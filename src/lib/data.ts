...
export const EMOTION_ARABIC_NAMES: Record<string, string> = {
  sad: "في حزن وضيق",
  anxious: "يبحث عن الطمأنينة",
  angry: "يريد كظم الغيظ",
  lonely: "يشعر بالوحدة",
  depressed: "يرجو فرج الهم",
  grateful: "شاكر ومُعترِف بنعمة الله",
  happy: "سعيد ومستبشر",
  confused: "حائر ويلتمس الهداية",
  scared: "خائف يطلب الأمان",
  suicidal: "في ضيق شديد ويطلب الفرج",
  bored: "يطلب انشراح الصدر",
  confident: "واثق بالله",
  content: "راضٍ ومطمئن",
  doubtful: "يلتمس اليقين والاطمئنان",
  greedy: "يرجو القناعة وسعة الرزق",
  guilty: "تائب ويطلب المغفرة",
  hurt: "مجروح يرجو جبر الخاطر",
  indecisive: "متردد يطلب الاستخارة",
  hypocritical: "يخشى النفاق ويسأل الإخلاص",
  jealous: "يستعيذ من الحسد والعين",
  lazy: "يستعيذ من العجز والكسل",
  lost: "تائه يطلب الرشاد",
  nervous: "متوتر يطلب الهدوء",
  overwhelmed: "مثقل ويطلب التيسير",
  regret: "نادم يرجو التوبة",
  tired: "متعب يطلب الراحة والقوة",
  unloved: "يطلب المحبة والأنس بالله",
  weak: "ضعيف يستمد القوة من الله",
