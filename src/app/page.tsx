      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="sm:hidden mb-6 relative">
          ...
          <input
            ...
            className="w-full bg-slate-900 border border-slate-800 rounded-xl pr-9 pl-4 py-2 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-[#CBA1D4]/50"
          />
        </div>
            ...
            {feelings.slice(0, 10).map((f: any) => {
              ...
              return (
                <Link
                  ...
                  className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-300 hover:text-white hover:border-[#CBA1D4]/40 transition-colors"
                >
          ...
          <div className="my-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-sm font-bold text-slate-200 flex items-center gap-2">
                <Search className="w-4 h-4 text-[#CBA1D4]" />
                <span>نتائج البحث ({searchResults.length})</span>
              </h2>
              <button
                onClick={() => setSearchQuery('')}
                className="text-xs text-[#CBA1D4] hover:underline font-semibold"
              >
                إلغاء البحث
              </button>
            </div>
          ...
          <div className="my-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-sm font-bold text-slate-300 flex items-center gap-2">
                <Compass className="w-4 h-4 text-[#CBA1D4]" />
