  ...
  return (
    <div className="flex flex-col min-h-screen dir-rtl">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        {/* Page Title */}
        <div className="glass-card p-6 sm:p-8 rounded-3xl mb-8 border border-emerald-500/30 flex flex-wrap items-center justify-between gap-4">
        ...
        {bookmarks.length > 0 ? (
          ...
          <div className="text-center py-20 glass-card rounded-3xl p-8 max-w-md mx-auto">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-2xl bg-emerald-500 text-slate-950 font-black text-xs hover:bg-emerald-400 transition-colors shadow-lg shadow-emerald-500/20"
            >
              تصفح المشاعر الآن
            </Link>
          </div>
