    ...
    <div className="clean-card p-5 sm:p-7 relative border border-slate-800/80 bg-[#111a33] text-right dir-rtl">
      ...
      {showEnglish && hasEnglishDetails && (
        <div className="mt-4 pt-4 border-t border-slate-800/60 space-y-3 text-xs text-slate-300">
          {dua.translation && (
            <div>
              <span className="font-bold text-emerald-400 block mb-1">الترجمة الإنجليزية (English Translation):</span>
        ...
        <div className="flex items-center gap-1.5">
          ...
          {dua.audio_url && (
            <button
              ...
              className="p-1.5 rounded-lg bg-slate-900 border border-slate-800 text-slate-300 hover:text-emerald-400 transition-colors"
              title="تلاوة صوتية"
            >
